"""
Django settings for laminart project.
...
WSGI_APPLICATION = 'laminart.wsgi.application'
...
AUTH_USER_MODEL = 'wellpaper.User'
LOGIN_URL = '/wellpaper/login/'
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
